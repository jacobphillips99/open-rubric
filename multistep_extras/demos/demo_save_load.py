...
from multistep_extras.example_rubrics.first_responder import requirements, scenarios
...
def main():
    ...
    loaded_scenarios = Scenario.load_multiple(output_dir / "first_responder_scenarios.yaml")
    ...
    loaded_req = Requirement.load_multiple(output_dir / "test_requirements_list.yaml")[0]
