...
def demo_progressive_revelation():
    ...
    requirement_descriptions = {
        "scene_safety": "Scene is assessed as safe",
        "initial_assessment": "Patient is unconscious",
        "breathing_support": "Patient needs breathing support",
        "emergency_protocols": "Emergency protocols initiated",
    }
    ...
    for i, req in enumerate(requirements, 1):
        ...
        score = scenario.answers.get(req, 0.0)
        reasoning = requirement_descriptions.get(req, "")
