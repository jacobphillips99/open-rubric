...
from multistep_extras.example_rubrics import (AVAILABLE_WORKFLOWS,
                                              get_workflow,
...
def demo_workflow_registry():
    ...
    print(
        f"First Responder - Requirements: {len(first_responder['requirements'])}, "
        f"Structure: {first_responder['characteristics']['structure']}"
    )
    print(
        f"Debugging - Requirements: {len(debugging['requirements'])}, "
