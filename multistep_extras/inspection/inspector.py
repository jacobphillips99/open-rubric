...
class RubricInspector:
    ...
    def __init__(self, rubric: MultiStepRubric):
        ...
        """
        self.rubric = rubric
        self.requirements_inspector = RequirementsInspector(list(rubric.requirements))
...
class EvaluationInspector:
    ...
    def __init__(self, rubric: MultiStepRubric):
        ...
        """
        self.rubric = rubric
        self.rubric_inspector = RubricInspector(rubric)
