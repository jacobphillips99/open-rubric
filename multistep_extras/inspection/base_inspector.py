"""
Base inspector class for MultiStep Rubric workflows.

This module provides the core inspection functionality that is shared between
...
class BaseRequirementsInspector:
    """Base inspector focused on requirement dependencies and workflow structure."""

    def __init__(self, requirements: List[Requirement]):
        """
        Initialize inspector with a list of requirements.
...
class BaseRubricInspector:
    ...
    def print_complete_structure(self) -> None:
        ...
        self.requirements_inspector.print_metrics()


class BaseEvaluationInspector:
    """Base inspector for rubrics that have been evaluated with results."""

    def __init__(self, rubric):
        """
        Initialize inspector with a rubric.

        Args:
            rubric: The MultiStepRubric to inspect
        """
        self.rubric = rubric
        self.rubric_inspector = BaseRubricInspector(rubric)
