...
scenarios = [
    ...
    Scenario(
        ...
        answers={
            "problem_reproduction": {"answer": 1.0, "reasoning": "The completion mentions reproducing the slow search behavior."},
            "log_examination": {"answer": 1.0, "reasoning": "The response mentions examining database logs for error messages and patterns."},
            "timeline_analysis": {"answer": 1.0, "reasoning": "The completion considers analyzing what changed over the past week."},
            "configuration_validation": {"answer": 1.0, "reasoning": "The response mentions checking database configuration changes."},
            "system_state_analysis": {"answer": 1.0, "reasoning": "The completion considers analyzing query execution plans and database state."}
        }
    )
] 